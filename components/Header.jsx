        ...
        <div className="bg-white border-b sticky top-0 z-50 shadow-sm">
            ...
            {isMenuOpen && (
                <div className="bg-white border-t absolute w-full left-0 top-16 shadow-xl py-4 px-6 flex flex-col gap-2 animate-fade-in z-50 h-[calc(100vh-64px)] overflow-y-auto pb-20">
                    ...
                    <button onClick={()=>handleNav('dashboard')} className="flex items-center gap-3 py-3 border-b border-gray-100 text-indigo-600 font-bold"><LayoutDashboard size={20}/> マイページ</button>
